                    ...
                    <div class="col s12" >
                            <div class="center-align">
                               <a class="btn waves-effect waves-light btn-large blue darken-3 z-depth-4" style ="width:300px; margin-bottom:10px"  href='<%=Url.Action("Login", "Home")%>'><b class="truncate">ENTRAR A SIG</b><a>
                                <a class="btn waves-effect waves-light btn-large blue darken-3 z-depth-4" style ="width:300px; margin-bottom:10px" href='http://143.208.18.66:82/areas/siap/MAP'><b class="truncate">ENTRAR A MAP</b><a>
                                <a class="btn waves-effect waves-light btn-large blue darken-3 z-depth-4" style ="width:300px; margin-bottom:10px" href='http://143.208.18.66:85/Core/Areas/SIAP/mapxd/'><b class="truncate">EXPEDIENTES DIGITALES</b><a>
