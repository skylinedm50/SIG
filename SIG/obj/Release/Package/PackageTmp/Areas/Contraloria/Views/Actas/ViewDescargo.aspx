...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script type="text/javascript" src="../../Scripts/actaDescargo.js"></script>--%>
    ...
    <script type="text/javascript" src='<% ResolveUrl("~/Areas/Contraloria/Scripts/actaDescargo.js")%>'></script>--%>
    ...
    <script type="text/javascript" src='/Areas/Contraloria/Scripts/actaDescargo.js'></script>
    ...
    <h2>Acta de Descargo</h2>
    <div id="contenidoActa" class="col_60" align="center">
               ...
               Sub(settings)
                   ...
                   settings.Items.AddGroupItem(
                       Sub(group)
                           ...
                           group.Items.Add(
                                Sub(item)
                                    item.Caption = "Fecha del acta de inconsistencias"
                                    item.SetNestedContent(
                                        Sub()
                                            Html.DevExpress().DateEdit(
                                               Sub(dte)
                                                   dte.Name = "dteInconsistencias"
