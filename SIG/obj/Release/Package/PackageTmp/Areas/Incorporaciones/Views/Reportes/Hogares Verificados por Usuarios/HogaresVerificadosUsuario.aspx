...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
  <style>        
    ...
    <h2>Hogares Verificados Por Usuario</h2>
    <br />
    <br />
    <%
        Html.BeginForm("Exportar_pv_reporteVerificacionesUsuario", "Reportes")
        Html.RenderAction("fnc_PivotGridReporteVerificacionesUsuario")
    %>
    <br />
    <br />
    <%
