...
<style>        
    ...
    <h2>Nuevas personas incorporadas</h2>

    <%
        Html.BeginForm("Exportar_gv_reporteHogares_nuevos_miembros", "Incorporaciones")
        Html.RenderAction("gv_PersonasNuevaIncorporacion")
    %>
    <br />
    <br />
    <%
