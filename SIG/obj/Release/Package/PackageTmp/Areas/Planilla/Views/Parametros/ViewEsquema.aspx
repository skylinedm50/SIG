...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="content-form-pla">
        <div id="mensaje-pla"></div>
            <%
                Html.RenderAction("GridViewPartialEsquema", "Parametros")
                Html.RenderPartial("Esquema/_PopupControlViewPartialEditEquema")
                Html.RenderPartial("Esquema/_PopupConfirBorrarEsquema")
            %>            
     </div>
    <script src="/Areas/Planilla/Scripts/Esquema/script_esquema.js"></script>
</asp:Content>
