...
Corresponsabilidad de Transferencia
</asp:Content>
...
<% Html.DevExpress().RenderScripts(Page,
    ...
    %>
    <div id="tit-form-pla"><h2>Corresponsabilidad de Transferencia</h2></div>
    <div id="content-form-pla">
        ...
        <%
            Html.RenderAction("GridViewOrdenCorresTransfer", New With {Key .Controller = "Shared", Key .intTipoCorres = 0, .intCodTransfer = 0, .intFocusIndice = 0, .intCodKeyGrid = 0})
        %>
    </div>
