...
%>
    ...
    <div id="tit-form-pla"><h2>Transferencia Acumulada</h2></div>
    <div id="content-form-pla">
        <%
            Html.RenderPartial("Transferencia_acumulada\_ControlesViewPartialTransferAcumu", "Parametros")
        %>
            <div id="mensaje-pla"></div>
    </div>

    <script src="/Areas/Planilla/Scripts/Transfere_acumulada/script_transferencia_acumulada.js"></script>
</asp:Content>
