...
<% Html.DevExpress().RenderScripts(Page,
    ...
    %>
    <div id="tit-form-pla">
            <h2>Cobertura de Planilla</h2>
    </div>
    <div id="content-form-pla">
            <%
                Html.RenderAction("FormLayoutControlEsquemasEnlazados", New With {Key .Controller = "Shared", Key .intTipoConfig = 0})
                Html.RenderAction("FormLayoutDetalleEsquemaEnlazado", New With {Key .Controller = "Shared", Key .intTipoConfig = 0, .intCodEsquema = 0})
    ...
    <script src="/Areas/Planilla/Scripts/Cobertura_planilla/script_cobertura_planilla.js"></script>
