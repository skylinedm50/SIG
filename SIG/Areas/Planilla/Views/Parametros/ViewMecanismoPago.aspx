...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    %>
    <div id="tit-form-pla"><h2>Mecanismo de Pago</h2></div>
    <div id="content-form-pla">
        <%
            Html.RenderAction("FormLayoutControlEsquemasEnlazados", New With {Key .Controller = "Shared", Key .intTipoConfig = 2})
            Html.RenderAction("FormLayoutDetalleEsquemaEnlazado", New With {Key .Controller = "Shared", Key .intTipoConfig = 2, .intCodEsquema = 0})
    ...
    <script src="/Areas/Planilla/Scripts/Mecani_pago/script_mecanismo_pago.js"></script>
