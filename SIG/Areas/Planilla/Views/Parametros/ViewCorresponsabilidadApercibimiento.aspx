...
Corresponsabilidad de Apercibimiento
</asp:Content>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    %>
<div id="tit-form-pla"><h2>Corresponsabilidad de Apercibimiento</h2></div>
    <div id="content-form-pla">
        <%
            Html.RenderPartial("Corresponsabilidad_de\_ControlesViewPartialCorresDe", "Shared")
        %>
            <div id="mensaje-pla"></div>
        <%
            Html.RenderAction("GridViewOrdenCorresTransfer", New With {Key .Controller = "Shared", Key .intTipoCorres = 1, .intCodTransfer = 0, .intFocusIndice = 0, .intCodKeyGrid = 0})
        %>
    </div>

    <script src="/Areas/Planilla/Scripts/Corresp_de/script_corresponsabilidad_de.js"></script>
    <script>
        $(document).ready(function () {
            objCorrespDe.TipoCorres = 1;
        });
    </script>
