...
<script>
    ...
    $('#container').highcharts('Map', {
            ...
            events: {
                drilldown: function (e) {
                    ...
                    if (!e.seriesOptions) {
                        ...
                        $.ajax({
                            url: "/Mineria/PlanillasPago/pv_mapaDiferenciaAltasBajasPlanillasDepartamento",
                            type: 'POST',
                            dataType: 'json',
                            //traditional: true,
                            data: {
        ...
        title: {
            text: 'Diferencia entre Altas y Bajas'
        },
        ...
        colorAxis: {
            dataClasses: [{
                to: 0,
                color: '#ff9d92',
                name: 'Mas bajas que altas'
            }, {
                from: 0,
                color: '#bde6ac',
                name: 'Mas altas que bajas'
            }]
        },
