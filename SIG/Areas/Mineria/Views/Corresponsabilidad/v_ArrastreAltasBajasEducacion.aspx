...
Arrastre, Altas y Bajas Educacion
</asp:Content>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script>
        $(document).ready(function () {
            $("#NombreReporte p").text("Arrastre, Altas y Bajas de Niños en Educación entre dos Pagos")
        })
    </script>
    ...
    <div id="hide">
        <% Html.BeginForm("exportarArrastreAltasBajasEducacion", "Corresponsabilidad")%>
        <div>
                                   ...
                                   Sub()
                                       Html.DevExpress().Button(
                                           Sub(btnConsultar)
                                               ...
                                               btnConsultar.Name = "btnConsultarArrastreAltasBajasEducacion"
                                               btnConsultar.UseSubmitBehavior = False
                                               btnConsultar.Text = "Consultar"
                                               btnConsultar.ClientSideEvents.Click = "btnConsultarArrastreAltasBajasEducacionClick"
                                           End Sub).GetHtml()
                                   End Sub)
                           End Sub)
                   End Sub).GetHtml()%>
