...
<script>
    ...
    $('#container').highcharts('Map', {
            ...
            events: {
                drilldown: function (e) {
                    ...
                    if (!e.seriesOptions) {
                        ...
                        $.ajax({
                            url: "/Mineria/Corresponsabilidad/pv_mapaDiferenciaAltasBajasEducacionDepartamento",
                            type: 'POST',
                            dataType: 'json',
                            data: {
                        ...
                        .done(function (response) {
                            ...
                            chart.addSeriesAsDrilldown(e.point, {
                                name: 'Diferencia entre Altas y Bajas de Niños en Educación',
        ...
        title: {
            text: 'Diferencia entre Altas y Bajas de Niños en Educación'
        },
