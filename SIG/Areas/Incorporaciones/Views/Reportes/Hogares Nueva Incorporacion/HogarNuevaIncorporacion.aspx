...
<style>        
    ...
    <h2>Hogares con nuevas incorporaciones</h2>

    <%
        Html.BeginForm("Exportar_pv_reporteHogares_nuevos_miembros", "Reportes")
        Html.RenderAction("pv_HogaresNuevaIncorporacion")
    %>
    <br />
    <br />
    <%
