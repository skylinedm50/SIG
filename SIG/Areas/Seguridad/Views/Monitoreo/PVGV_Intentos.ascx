...
<%
    Html.DevExpress.GridView(Sub(gdv)
                                 gdv.Name = "GdvIntentos"
                                 gdv.Width = Unit.Percentage(100)
                                 gdv.CallbackRouteValues = New With {Key .Controller = "Monitoreo", Key .Action = "PVGV_Intentos"}
                                 ...
                                 gdv.Columns.Add("nombre_usuario_intento_logeo", "Usuario con el que intentó ingresar")
